...
export const THEME_COLORS: Record<ThemeVariant, ThemeColors> = {
  sageLibrary: {
    ...
    sidebarBg: '#243D35',
    sidebarText: '#D8EBE4',
    sidebarMuted: 'rgba(216,235,228,0.62)',
  ...
  linen: {
    ...
    sidebarBg: '#2B2520',
    sidebarText: '#EDE3D4',
    sidebarMuted: 'rgba(237,227,212,0.62)',
  ...
  slate: {
    ...
    sidebarBg: '#1E2535',
    sidebarText: '#CBD5E8',
    sidebarMuted: 'rgba(203,213,232,0.62)',
    sidebarActiveBackground: 'rgba(255,255,255,0.08)',
    sidebarDivider: 'rgba(255,255,255,0.07)',
  },
  dustyPlum: {
    ...
    sidebarBg: '#2D1F45',
    sidebarText: '#DDD5EE',
    sidebarMuted: 'rgba(221,213,238,0.62)',
    sidebarActiveBackground: 'rgba(255,255,255,0.09)',
    sidebarDivider: 'rgba(255,255,255,0.07)',
  },
  navy: {
    ...
    sidebarBg: '#181C24',
    sidebarText: '#D6DBE6',
    sidebarMuted: 'rgba(214,219,230,0.62)',
    sidebarActiveBackground: 'rgba(255,255,255,0.08)',
    sidebarDivider: 'rgba(255,255,255,0.07)',
  },
  inkLight: {
    ...
    sidebarBg: '#2A1F15',
    sidebarText: '#F5E8D8',
    sidebarMuted: 'rgba(245,232,216,0.62)',
    sidebarActiveBackground: 'rgba(255,255,255,0.09)',
    sidebarDivider: 'rgba(255,255,255,0.07)',
  },
  ...
  dune: {
    ...
    sidebarBg: '#100E0C',
    sidebarText: '#E8DFD0',
    sidebarMuted: 'rgba(232,223,208,0.62)',
    sidebarActiveBackground: 'rgba(255,255,255,0.06)',
    sidebarDivider: 'rgba(255,255,255,0.05)',
  },
  slateDark: {
  ...
  ink: {
    ...
    sidebarBg: '#0E1014',
    sidebarText: '#DDD7CE',
    sidebarMuted: 'rgba(221,215,206,0.62)',
    sidebarActiveBackground: 'rgba(255,255,255,0.06)',
    sidebarDivider: 'rgba(255,255,255,0.05)',
  },
}
